...
Dentro ya hay piezas reales, no promesas: Sílabas en mis manos, UMBRA, FonoMundos, Golosinas Lingüísticas — y esta semana se han sumado dos más, un Parchís adaptado para Audición y Lenguaje y otro juego para denominación y fonología: https://www.linkedin.com/posts/joseaserraf_audicionylenguaje-logopedia-parchis-activity-7491523947998547968-yRO3 Cada una nació de una necesidad real, y cada una mejora porque alguien la prueba y dice "esto funciona", "esto sobra", "esto para mi caso no sirve".
